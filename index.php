  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">SUCCESS 2020</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <p>ketentuan terkait Success 2020 :</p>
			<p>1. Dresscode hem putih dengan jaket almamater selama mengikuti acara</p>
			<p>2. Download file crapeline dan wartegg dan cetak dalam kertas A4 yang akan digunakan pada saat acara</p>
			<p>3. Siapkan 2 lembar kertas A4</p>
      </div>
